...
p1 = Project.create!(title: "Help the whales eat more nutrients11", user_id: 1, category_id: 2, end_date: Date.new(2017, 4, 28), brief: "I'm going to throw meat into the sea so the whales can get more nutrients, I think a pack of 6 richmonds pork saussages should do the trick!!", image: File.open(File.join(Rails.root, "db/images/alexchin2.jpg")), video: "https://www.youtube.com/embed/XGSy3_Czz8k?playlist=XGSy3_Czz8k&loop=1", target_amount: 50 )
